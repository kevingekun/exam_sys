...
public class CommonJdbcCore {
		...
		if(args!=null){
			for(int i=0;i<args.length;i++){
				...
				if(arg!=null){
					...
					}else if(arg.getClass().equals(Integer.class)||arg.getClass().equals(int.class)){
					...
					}else if(arg.getClass().equals(Double.class)||arg.getClass().equals(double.class)){
			...
			for(int i=0;i<args.length;i++){
				...
				if(String.class.equals(type)){
					if(arg!=null)
						...
						ps.setNull(i+1, Types.VARCHAR);
				}else if(Integer.class.equals(type)||Byte.class.equals(type)||Short.class.equals(type)
	...
	private void processAnnoColumn(List list, Column column, Object value){
		if(column!=null){
			if(column.length()>0&&value!=null&&value.getClass().equals(String.class)){
